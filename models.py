...
class Questionset(Base):
    ...
    groupquestions = relationship(
        "GroupQuestion", back_populates="questionsets")
...
class GroupQuestion(Base):
    ...
    questionsets = relationship(
        "Questionset", back_populates="groupquestions", foreign_keys=[questionset_id])
...
class Question(Base):
    ...
    groupquestion_id = Column(Integer, ForeignKey(
        "groupquestions.groupquestion_id"))
    ...
    groupquestions = relationship(
        "GroupQuestion", back_populates="questions", foreign_keys=[groupquestion_id])
    questionoptions = relationship(
        "QuestionOption", back_populates="questions")
...
class QuestionOption(Base):
    ...
    questions = relationship(
        "Question", back_populates="questionoptions", foreign_keys=[question_id])
